          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-[12px] text-[#444653] mt-1 leading-relaxed">
                Menghapus <strong>seluruh {productCount} data produk</strong> dari katalog inventaris sehingga sistem siap diisi data riil baru atau diimpor via Excel.
              </p>
            </div>
          </div>

          {/* Option 2: Reset Filter Saja */}
          <div
