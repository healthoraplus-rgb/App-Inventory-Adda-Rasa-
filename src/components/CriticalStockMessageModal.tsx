...
Kepada Yth.
*${activeSupplier.name}*
UP: ${activeSupplier.contactPerson || 'PIC Supplier'}

Dengan hormat,
Melalui pesan s sistem inventaris ADDA RASA KJD, kami ingin memberitahukan bahwa ketersediaan stok fisik untuk produk rekanan Anda telah mencapai *batas minimum / kritis*. 

Berikut adalah rincian permintaan pesanan restock darurat:

${itemsListText.trim()}

${customNotes ? `*Catatan Khusus:* \n${customNotes}\n\n` : ''}Mohon konfirmasi ketersediaan barang, estimasi jadwal pengiriman ke gudang kami
