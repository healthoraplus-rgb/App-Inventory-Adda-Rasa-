          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pb-6 border-b border-[#c4c5d5]/20">
            ...
            <div className="text-center sm:text-left flex-1">
              ...
              <p className="text-[12px] text-[#444653] mt-0.5">
                <span className="font-semibold text-[#00288e]">Alamat Resmi:</span> Adda Rasa KJD Kompleks Alvita Blok Q Nomor 14, Kelurahan Sawah Lama, Kecamatan Ciputat, Kota Tangerang Selatan, Banten
              </p>
              ...
              {syncState?.isConnected ? (
                <div className="flex items-center gap-3">
                  <span className="text-[12px] text-[#006c49] font-medium hidden md:inline">
                    Terhubung ({syncState.googleUserEmail || syncState.userEmail || 'Google Connected'})
                  </span>
                  {onOpenGoogleSheetsModal && (
                    <button
                      type="button"
                      onClick={onOpenGoogleSheetsModal}
                      className="px-3.5 py-2 border border-[#00288e]/40 text-[#00288e] rounded-xl hover:bg-[#f4f2fc] text-[13px] font-bold transition-colors cursor-pointer"
                    >
                      Kelola Sinkronisasi
                    </button>
                  )}
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  >
                    ...
                    <span>{activeAction === 'Koneksi Google' ? 'Membuka Pop-up...' : 'Login Pop-up'}</span>
                  </button>
                  ...
                  {onOpenGoogleSheetsModal && (
                    <button
                      type="button"
                      onClick={onOpenGoogleSheetsModal}
                      className="px-4 py-2.5 bg-[#00288e] text-white rounded-xl text-[13px] font-bold hover:bg-[#1e40af] transition-all cursor-pointer flex items-center gap-1.5 shadow-xs"
                    >
                      <span className="material-symbols-outlined text-[16px]">settings</span>
                      <span>Opsi Koneksi Lain (Web App)</span>
                    </button>
                  )}
                </div>
              )}
